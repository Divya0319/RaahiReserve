...
@Component
public class MoreBusesSampleDataInitializer {
    ...
    @Autowired
    public MoreBusesSampleDataInitializer(BusRepository busRepository, RouteRepository routeRepository, BusRouteRepository busRouteRepository) {
